      ...
      <div className="wrapper">
        ...
        <div className="section" style={{backgroundImage:`url(${BackgroundImage})`}}>
              ...
              <Col className="ml-auto mr-auto" md="8">
                <h2 className="title">ARTICLE 1 - DEFINITIONS</h2>
                <h5 className="description">
              ...
              <Col className="ml-auto mr-auto" md="8">
                <h2 className="title">ARTICLE 2 - ACCESS TO THE WEBSITE</h2>
                <h5 className="description">
              ...
              <Col className="ml-auto mr-auto" md="8" >
                <h2 className="title" >ARTICLE 3 - WEBSITE CONTENT</h2>
                <h5 className="description">
...
can not be considered as a tacit consent, nor of a waiver of any right to prosecute the infringing party.</p>
              ...
              <div className="section" style={{color:'white',
                ...
                marginTop:'-30px'}}>
              <Col className="ml-auto mr-auto" md="8">
                <h2 className="title">ARTICLE 4 - MANAGEMENT OF THE WEBSITE</h2>
                <h5 className="description">
...
Make the website temporarily unavailable in order to perform updates
              ...
              <Col className="ml-auto mr-auto" md="8">
                <h2 className="title">ARTICLE 5 - RESPONSIBILITIES</h2>
                <h5 className="description">
...
subsequent damages from you.</p>
              ...
              <Col className="ml-auto mr-auto" md="8">
                <h2 className="title">ARTICLE 6 - COLLECTION OF DATA</h2>
                <h5 className="description">
...
(electronic) register.</p>
              ...
              <Col className="ml-auto mr-auto" md="8">
                <h2 className="title">ARTICLE 7 - YOUR RIGHTS REGARDING INFORMATION</h2>
                <h5 className="description">
...
where we can contact you.</p>
              ...
              <Col className="ml-auto mr-auto" md="8">
                <h2 className="title">ARTICLE 8 - LEGAL OBLIGATIONS</h2>
                <h5 className="description">
              ...
              <Col className="ml-auto mr-auto" md="8">
                <h2 className="title">ARTICLE 9 - COLLECTED DATA AND COMMERCIAL OFFERS</h2>
                <h5 className="description">
...
the mandatory nature of this information when requesting these data.</p>
              ...
              <Col className="ml-auto mr-auto" md="8">
                <h2 className="title">ARTICLE 10 - DATA RETENTION</h2>
                <h5 className="description">
              ...
              <Col className="ml-auto mr-auto" md="8">
                <h2 className="title">ARTICLE 11 - COOKIES</h2>
                <h5 className="description">
...
We can not see who visits our sites or from which personal device the visit has taken place.</p>
              ...
              <Col className="ml-auto mr-auto " md="8">
                <h2 className="title">ARTICLE 12 - IMAGERY AND PRODUCTS OFFERED</h2>
                <h5 className="description">
                <p>You cannot derive any rights from the imagery that accompanies any offered product on our website.</p>                
                </h5>
              </Col>
              <Col className="ml-auto mr-auto " md="8">
                <h2 className="title">ARTICLE 13 - APPLICABLE LAW</h2>
                <h5 className="description">
...
the sole jurisdiction if any dispute regarding these conditions may arise, save when a legal exception applies.</p>
              ...
              <Col className="ml-auto mr-auto " md="8">
                <h2 className="title">ARTICLE 14 - CONTACT</h2>
                <h5 className="description">
